        ...
        if (args.isEmpty()) {
            ...
            channel.sendMessageEmbeds(embedBuilder.build()).setActionRows(
                    ActionRow.of(
                        ...
                        Button.secondary(ctx.getMember().getUser().getId() + ":game", "Games").withEmoji(Emoji.fromEmote("info", Long.parseLong("870871190217060393"), true))),
                    ActionRow.of(
                        Button.secondary(ctx.getMember().getUser().getId() + ":music", "Music").withEmoji(Emoji.fromEmote("info", Long.parseLong("870871190217060393"), true)),
